...
const WatchLive = () => {
  ...
  return (
    <div className="w-full text-black">
      {/* LOVE TO ALL */}
      <div className="w-full bg-gray-700 text-center py-2 font-bold text-lg capitalize">
        LOVE TO ALL
      </div>
      ...
      {/* Bookmark It */}
      <div className="w-full bg-gray-700 text-center py-2 font-bold text-lg capitalize mt-4">
        Bookmark It👇 to Stay With Us
      </div>

      {/* BPL Link */}
      <div className="w-full bg-gray-700 text-center py-2 font-bold text-lg capitalize mt-2">
        BPL25.NETLIFY.APP
      </div>
